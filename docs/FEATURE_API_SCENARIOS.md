...
4. 기대 결과
   ...
   - 공식 조별 결과는 BO3로만 등록
   - A조/B조를 먼저 선택하고 해당 조의 팀끼리 결과 입력
...
3. 기대 결과
   ...
   - 스크림은 2경기 세트 또는 BO3 중 선택
   - 2경기 세트는 2:0, 1:1, 0:2 허용
   - BO3는 2:0, 2:1, 0:2, 1:2 허용
   - 승률 카드에서 팀을 선택하면 날짜·상대·스코어 내역 표시
...
- 스크림 결과: 2경기 세트 등록·수정, 무승부, 팀별 상세 내역
